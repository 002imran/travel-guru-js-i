...
function calculateCost(obj) {
  ...
  const newFare =parseFloat(fareDiv.innerHTML)
  // console.log('newFare', newFare);
  
  // console.log(fareDiv,'total');
  taxTotal.innerHTML = (fareDiv.innerHTML * .15);
  const newTax = parseFloat(taxTotal.innerHTML);
  // console.log(newTax, 'newtaxfee');

  totalCost.innerHTML = newFare + newTax;




  console.log(taxTotal, 'totaltax');
}
